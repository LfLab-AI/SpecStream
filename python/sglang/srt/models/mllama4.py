...
class Llama4ForConditionalGeneration(nn.Module):
    ...
    def get_embed_and_head(self):
        # For backend, we delegate to the language model which should have this method
        # If the language model doesn't have lm_head (like backend), we return None for head
        ...
        if hasattr(self.language_model, "get_embed_and_head"):
            ...
            # For backend, head might not be needed
            return embed, None
